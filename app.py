...
# ==================== الخطوة الرابعة (تم إصلاح تشفير اللغة العربية هنا) ====================
    ...
    if st.session_state['satellite_data'] is None:
        ...
        if not target_df.empty:
            # الحل الجذري للغة العربية: تحويل لترميز utf-8-sig مع إزالة ترويسة sep لكي يقرأه Excel مباشرة بدون رموز غريبة
...
# ==================== الخطوة الخامسة (تم إزالة أخطاء الصياغة بالكامل هنا) ====================
